...
CREATE TABLE CONCESIONARIOS(
	DLR_ID INT NOT NULL AUTO_INCREMENT UNIQUE PRIMARY KEY,
    DLR_CODE CHAR(3) NOT NULL UNIQUE,
    CONCESIONARIO VARCHAR(50) NOT NULL
);

CREATE TABLE SUCURSALES(
	SUC_ID INT NOT NULL AUTO_INCREMENT UNIQUE PRIMARY KEY,
...
CREATE TABLE INSUMOS(
	PART_ID INT NOT NULL AUTO_INCREMENT UNIQUE PRIMARY KEY,
...
CREATE TABLE control_ot (
    ...
    FOREIGN KEY (OR_ID) REFERENCES ORDEN_DE_TRABAJO (OR_ID)
);
